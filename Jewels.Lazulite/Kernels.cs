...
public partial class Compute
{
    ...
    public static KernelStorage<Action<Index1D, ArrayView1D<float, Stride1D.Dense>, float>> FillKernel { get; private set; } = new(SimpleKernels.FillKernel);
    public static KernelStorage<Action<Index1D, ArrayView1D<float, Stride1D.Dense>>> ZeroKernel { get; private set; } = new(SimpleKernels.ZeroKernel);

    public static KernelStorage<Action<Index1D, ArrayView1D<float, Stride1D.Dense>, ArrayView1D<float, Stride1D.Dense>>> CopyKernel { get; private set; } =
        new(SimpleKernels.CopyKernel);

    public static KernelStorage<Action<Index1D, ArrayView1D<float, Stride1D.Dense>, ArrayView1D<float, Stride1D.Dense>,
        ArrayView1D<float, Stride1D.Dense>>> ConcatKernel { get; private set; } = new(SimpleKernels.ConcatKernel);
